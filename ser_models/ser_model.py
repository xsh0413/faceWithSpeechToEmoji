...
from ser_models.ser_spec import SER_AlexNet
...
class Ser_Model(nn.Module):
    def __init__(self):
        ...
        # CNN for Spectrogram
        self.alexnet_model = SER_AlexNet(num_classes=7, in_ch=3, pretrained=True)
        ...
        # WAV2VEC 2.0
        self.wav2vec2_model = Wav2Vec2Model.from_pretrained("models/wav2vec2-base-960h")
        ...
        self.post_att_layer_3 = nn.Linear(128, 7)
    ...
    def forward(self, audio_spec, audio_mfcc, audio_wav):      
        ...
        output_att = self.post_att_layer_3(audio_att_2) # [batch, 7] 
